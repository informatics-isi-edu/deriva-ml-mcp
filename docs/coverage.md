...
| add_dataset_type | dataset.py | merged | deriva_ml_update_dataset_types | tools/dataset/mutate.py | combined add+remove into one tool | Single-action sugar over the bulk add_dataset_types/remove_dataset_type pair |
| remove_dataset_type | dataset.py | merged | deriva_ml_update_dataset_types | tools/dataset/mutate.py | combined add+remove into one tool | Same merge as add_dataset_type |
